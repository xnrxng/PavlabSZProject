  ...
  for (method in method_list){
    ...
    for (excitatory in exc_neurons){
      ...
      if(method == "LimmaCPMLog"){
        ...
        res_volcano <- EnhancedVolcano(results, lab = rownames(results),
            x = 'logFC', y = 'adj.P.Val', title = excitatory, subtitle = NULL, FCcutoff = 0.1, pCutoff = 0.05, legendPosition = "none", caption = NULL,
            axisLabSize = 10, titleLabSize = 10, labSize = 3, pointSize = 1, ylim = c(0, max(-log10(results$adj.P.Val))+1))
        ...
        plot_list[[excitatory]] <- res_volcano
          ...
          res_volcano <- EnhancedVolcano(results, lab = rownames(results),
            x = 'groupdisorderyes', y = 'adj.P.Val', title = excitatory, subtitle = NULL, FCcutoff = 0.1, pCutoff = 0.05, legendPosition = "none", caption = NULL,
            axisLabSize = 10, titleLabSize = 10, labSize = 3, pointSize = 1, ylim = c(0, max(-log10(results$adj.P.Val))+1))
          plot_list[[excitatory]] <- res_volcano
        }
      }
  ...
  for (method in method_list){
    ...
    for (inhibitory in inh_neurons){
      ...
      if(method == "LimmaCPMLog"){
        ...
        res_volcano <- EnhancedVolcano(results, lab = rownames(results),
                                       x = 'logFC', y = 'adj.P.Val', title = inhibitory, subtitle = NULL, FCcutoff = 0.1, pCutoff = 0.05, legendPosition = "none", caption = NULL,
                                       axisLabSize = 10, titleLabSize = 10, labSize = 3, pointSize = 1, ylim = c(0, max(-log10(results$adj.P.Val))+1))
        ...
        res_volcano <- EnhancedVolcano(results, lab = rownames(results),
                                       x = 'groupdisorderyes', y = 'adj.P.Val', title = inhibitory, subtitle = NULL, FCcutoff = 0.1, pCutoff = 0.05, legendPosition = "none", caption = NULL,
                                       axisLabSize = 10, titleLabSize = 10, labSize = 3, pointSize = 1, ylim = c(0, max(-log10(results$adj.P.Val))+1))
        plot_list[[inhibitory]] <- res_volcano
      }
    }
