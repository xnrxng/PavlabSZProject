...
Lastly, in @fig-depthdistribution, the sequencing depth of each cell was investigated. These results were grouped together per cell type in the following plot, and colored by cohort. The CMC points are obscured by the other ones, as they fell within the middle range.
